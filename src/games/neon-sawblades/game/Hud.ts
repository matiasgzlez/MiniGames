...
/** DOM overlay: live score plus start / game-over screens and the countdown. */
export class Hud {
  ...
  constructor(container: HTMLElement) {
    ...
    this.hintEl.textContent = "flechas para moverte · espacio para saltar (doble salto)";
  ...
  showStart(): void {
    this.titleEl.textContent = "NEON SAWBLADES";
  ...
  showGameOver(score: number, best: number): void {
    ...
    this.scoreLineEl.textContent =
      score >= best && score > 0
        ? `MONEDAS: ${score} — ¡NUEVO MEJOR!`
        : `MONEDAS: ${score}  ·  MEJOR: ${best}`;
