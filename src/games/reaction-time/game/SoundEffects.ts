...
export class SoundEffects {
  ...
  /** Sharp "go" beep the instant the card turns green. */
  static playGo(): void {
    tone(880, "sine", 0.16, 0.12);
  }

  /** Crisp confirmation when the reaction is registered. */
  static playReaction(): void {
    tone(1174.66, "triangle", 0.14, 0.14);
  }

  /** Low buzz on an early (foul) click. */
  static playFoul(): void {
    tone(150, "sawtooth", 0.14, 0.25, 75);
  }
