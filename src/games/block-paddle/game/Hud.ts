...
export class Hud {
  ...
  showStart(best: number): void {
    this.titleEl.textContent = "BLOCK PADDLE";
    this.subtitleEl.textContent = "devolve la pelota con la barra, no dejes que caiga";
    ...
    this.hintEl.textContent = "presiona ENTER o toca para empezar";
    this.leaderboard.clear();
